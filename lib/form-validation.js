(function (global, factory) {
      ...
      v.extend(validate, {
        ...
        collectFormValues: function collectFormValues(form, options) {
          ...
          inputs = form.querySelectorAll(
            `input, textarea, select, [data-vl-error-placeholder], .${fvSelectClass}`
          );
  ...
  var _showErrors = function _showErrors(form, errors) {
    vl.util.each(form.querySelectorAll("input, textarea, select, [data-vl-error-placeholder], .".concat(fvSelectClass)), function (input) {
  ...
  var FormValidation = /*#__PURE__*/function () {
    ...
    _createClass(FormValidation, [{
      ...
      value: function dress(form) {
        ...
        fields = form.querySelectorAll("input, textarea, select, [data-vl-error-placeholder], .".concat(fvSelectClass));
